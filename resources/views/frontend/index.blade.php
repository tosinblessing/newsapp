...
<section id="feature_news_section" class="feature_news_section">
 ...
 <img class="img-responsive top_static_article_img" src="{{ asset('frontend/img/feature-static1.jpg') }}"  alt="">
                    </div>
                    <!-- feature_article_img -->
...
4, 2015</a></div>
            ...
            <div class="col-md-5">
                    <div class="feature_static_last_wrapper">
                        <div class="feature_article_img">
                            <img class="img-responsive" src="{{asset('frontend/img/feature-static2.jpg')}}" alt="feature-top">
                        </div>
                        <!-- feature_article_img -->
                        ...
                        <div class="col-md-6">
                            <div class="top_article_img">
                                <a href="single.html" target="_self">
                                    <img class="img-responsive" src="{{asset('frontend/img/cat-mobi-left-1.jpg')}}" alt="feature-top">
                                </a>
                            </div>
                            <!----top_article_img------>
                        </div>
                ...
                <div class="category_article_wrapper">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object" src="{{asset('frontend/img/cat-mobi-sm1.jpg')}}" alt="Generic placeholder image"></a>
                                </div>
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#"><img class="media-object" src="{{asset('frontend/img/cat-mobi-sm3.jpg')}}" alt="Generic placeholder image"></a>
                                </div>
                                <div class="media-body">
                                    <span class="tag purple">Mobile</span>
                        ...
                        <div class="col-md-6">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#"><img class="media-object" src="{{asset('frontend/img/cat-mobi-sm2.jpg')}}" alt="Generic placeholder image"></a>
                                </div>
                                <div class="media-body">
                                    <span class="tag purple">Mobile</span>
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#"><img class="media-object" src="{{asset('frontend/img/cat-mobi-sm4.jpg')}}" alt="Generic placeholder image"></a>
                                </div>
                                <div class="media-body">
                                    <span class="tag purple">Mobile</span>
